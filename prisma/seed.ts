...
const cars = [
...

  {
    ...
    charging: "120 kW DC Fast Charging",
    description:
      "A futuristic electric SUV with intelligent technology and premium styling.",
    img: "https://wzszopkfpswtttmpqaeg.supabase.co/storage/v1/object/public/autovault/Deepal-S07.jpg",
    features: [
      "AR head-up display",
      "ADAS",
      "Panoramic roof",
...

  {
    ...
    img: "https://wzszopkfpswtttmpqaeg.supabase.co/storage/v1/object/public/autovault/DEEPAL%20SL03.jpg",
    features: [
      "Frameless doors",
      "AR HUD",
      "Panoramic roof",
...

  {
    ...
    charging: "80 kW DC Fast Charging",
    description:
      "A stylish electric SUV blending bold design with modern technology and efficiency.",
    img: "https://wzszopkfpswtttmpqaeg.supabase.co/storage/v1/object/public/autovault/chery-omoda-e5.jpg",
    features: [
      "Dual screens",
      "ADAS",
      "360° camera",
